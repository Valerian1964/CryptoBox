...
#[derive(Debug)]
pub struct CryptoBoxProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoBoxProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoBox processing");
    
    let mut processor = CryptoBoxProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoBoxProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoBoxProcessor::new(false);
